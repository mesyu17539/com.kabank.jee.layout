...
<form id="join_form" method="post" action="/user2/join.nhn?m=check" onsubmit="return mainSubmit(0);">		
	...
	<input type="hidden" id="token_sjoin" name="token_sjoin" value="ipwfbVhiEq8CQV11">
	...
	<input type="hidden" id="encPswd" name="encPswd" value="">
	<input type="hidden" id="encKey" name="encKey" value="100012769">
    ...
    <input type="hidden" id="nid_t2" name="nid_t2" value="20171220371a7e29-f0c6-4850-a562-5decb3912ff8">
